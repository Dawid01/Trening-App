...
abstract public class VisualizerBase extends View {
    ...
    public VisualizerBase(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
        init();
    }

    public VisualizerBase(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setPlayer(int audioSessionId) {
        ...
        visualizer.setDataCaptureListener(new Visualizer.OnDataCaptureListener() {
            ...
            public void onWaveFormDataCapture(Visualizer visualizer, byte[] bytes,
                                              int samplingRate) {
                VisualizerBase.this.bytes = bytes;
                invalidate();
            }
